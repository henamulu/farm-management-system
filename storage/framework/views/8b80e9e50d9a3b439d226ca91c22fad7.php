            ...
            <div class="mb-6">
                ...
                <a href="<?php echo e(route('messages.index')); ?>" 
                   class="flex items-center justify-between text-gray-700 hover:text-green-600 py-2">
                    ...
                    <?php if($unreadCount = Auth::user()->messages()->where('status', 'unread')->count()): ?>
                        <span class="bg-green-500 text-white rounded-full text-xs px-2"><?php echo e($unreadCount); ?></span>
                    <?php endif; ?>
                </a>
            </div>
                ...
                <div class="space-y-1">
                    ...
                    <div x-data="{ 
                        ...
                        <div x-show="open" 
                            ...
                            <?php if($farms->isNotEmpty()): ?>
                                <a href="<?php echo e(route('farms.plans.create', $farms->first())); ?>" 
                                   class="block text-gray-600 hover:text-green-600 py-1">
                                    Create Plan
                                </a>
                                <a href="<?php echo e(route('farms.plans.index', $farms->first())); ?>" 
                                   class="block text-gray-600 hover:text-green-600 py-1">
                                    Plan List
                                </a>
                            <?php endif; ?>
