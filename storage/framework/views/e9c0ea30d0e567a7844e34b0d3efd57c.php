                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="<?php echo e(route('farms.employees.index', $farm)); ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                    View All Employees
                                </a>
                            </div>
                            <div class="bg-gray-50 p-4 rounded">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="<?php echo e(route('farms.stocks.index', $farm)); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                    View All Items
                                </a>
                            </div>
                            <div class="bg-gray-50 p-4 rounded">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="<?php echo e(route('farms.machinery.index', $farm)); ?>" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                                    View All Machinery
                                </a>
                            </div>
                            <div class="bg-gray-50 p-4 rounded">
