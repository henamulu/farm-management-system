        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold mb-4">New Farm</h2>
                    ...
                    <form action="<?php echo e(route('farms.store')); ?>" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('farms.index')); ?>" 
...
<?php endif; ?> <?php /**PATH D:\woonde-farm-project\farm-management-system\resources\views/farms/create.blade.php ENDPATH**/ ?>